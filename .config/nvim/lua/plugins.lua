...
require 'mason-tool-installer'.setup {
    ...
    ensure_installed = { -- you can turn off/on auto_update per tool
        'bash-language-server', 'diagnostic-languageserver', 'dockerfile-language-server', 'dot-language-server',
        'eslint_d', 'eslint-lsp', 'jq', 'json-lsp', 'markdownlint', 'node-debug2-adapter',
        'prettier', 'prettierd', 'shellcheck', 'shellcheck', 'typescript-language-server', 'vim-language-server', 'vint',
        'xmlformatter', 'yaml-language-server', 'yamllint', 'lua-language-server',
        -- 'sumneko_lua',
        -- 'gopls',
